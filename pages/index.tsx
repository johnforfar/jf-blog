      ...
      <header className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-4">
        <div className="w-full px-4 max-w-screen-2xl mx-auto">
          ...
          <div className="flex gap-4 mb-4">
            <a href="https://x.com/johnforfar" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
              <span>@johnforfar</span>
            </a>
            <a href="https://www.youtube.com/@John-Forfar" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-500 transition-colors">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <footer className="border-t border-gray-200 dark:border-gray-700 mt-6 pt-6 pb-8">
        <div className="w-full px-4 max-w-screen-2xl mx-auto text-center">
          ...
          <div className="flex gap-4 mb-4 justify-center">
            ...
            <a href="https://github.com/johnforfar" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
